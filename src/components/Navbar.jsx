...
import { FaSignOutAlt, FaMoon, FaSun, FaClock } from 'react-icons/fa';
...
const Navbar = ({ isDarkMode, toggleTheme }) => {
    ...
    return (
        <nav className="sticky top-0 z-50 bg-white/80 dark:bg-gray-900/80 backdrop-blur-lg border-b border-gray-200/60 dark:border-gray-700/60 transition-colors duration-300 shadow-sm">
